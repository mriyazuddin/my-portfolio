...
var isReplit = process.env.REPL_ID !== void 0 && process.env.NODE_ENV !== "production";
var vite_config_default = defineConfig({
  plugins: [
    ...
    ...isReplit ? [
      ...
      (await import("@replit/vite-plugin-runtime-error-modal")).default?.() ?? (await import("@replit/vite-plugin-runtime-error-modal")).then((m) => m.default?.()),
      // @ts-expect-error dynamic import in config env
